...
Теперь можно приступить к реализации DevicePage. Это страница которая будет отображать детали о конкретном товаре, при выборее его из перечня всех товаров в магазине.