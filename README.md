...
На этом мы зарешаем визуальную верстку сайта и будем приступать к связыванию функционала нашего фронтенда с бекендом. Для этого создадим папку "http" и внутри нее файл "index.js".
