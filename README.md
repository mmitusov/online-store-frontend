...
Теперь пришло время оживить нашу админ панель не только на получение, но и на добавление типов, брендов и устройств в БД нашего бекенда. Напишем логику по добавлению/сохранению типов, брендов и устройств на наш бекенд, после отправки ввод информации на UI нашего фронтернда
