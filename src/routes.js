...
export const publicRoutes = [
    ...
    {
        path: DEVICE_ROUTE + '/:id', //При просмотре конкретного устройства в url добавим также и /:id конкретного устройства, чтобы мы могли делать запрос на сервер и это устройство получать
