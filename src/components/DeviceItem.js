...
//То есть, мы берем id-шник конкретного товара из mobx и по нему делаем запрос на сервер, для получения данных о товаре (нас полностью преводит с текущей страницы на страницу с товаром)
